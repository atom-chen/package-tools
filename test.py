...
if __name__ == '__main__':
    ...
    for label in options.labels.split( '|' ):
        ...
        os.system( 'cp 120027_empty.list 120027_%s.list'%label )
        os.system( 'cp 120028_empty.list 120028_%s.list'%label )
        os.system( 'cp 120029_empty.list 120029_%s.list'%label )
        os.system( 'cp 120030_empty.list 120030_%s.list'%label )
